			...
			<tbody>
				<tr>
					...
					<td>
						...
						<c:if test="${!empty uid }">
						<input type="text" name="id" id="id" size="100" class="single100" value="${uid }" placeholder="아이디 입력" required>
						</c:if>
				...
				<tr>
					...
					<td><input type="tel" name="phone" id="phone" class="single100"  pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" placeholder="00*-000*-0000 입력" required></td>
				</tr>
				<tr>
