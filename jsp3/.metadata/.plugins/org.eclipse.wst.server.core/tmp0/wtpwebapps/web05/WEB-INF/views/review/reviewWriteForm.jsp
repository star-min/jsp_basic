		...
		<table class="table_form">
			<tbody>
				...
				<tr>
					<th>이미지</th>
					<td>
						<input type="file" accept="*.jpeg,*.jpg, *.png, *.gif" name="image" class="input is-primary">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="nickname" id="nickname" size="40" class="single40" value="${sid }" readonly></td>
				</tr>
				<tr>
					<td colspan="2">
