...
<title>자료 상세보기</title>
<link rel="stylesheet" href="${path1 }/databank/reset.css">
<link rel="stylesheet" href="${path1 }/databank/common.css">
</head>
<body>
<div id="scont" style="padding-bottom: 200px">
				...
				<tr>
					...
					<td>
						...
						<c:if test="${sid!='admin' }">
							...
							<c:if test="${filetype=='gif' }"><img src="${path1 }/img/img.png" alt="파일타입"/></c:if>				
							<c:if test="${filetype=='jpg' }"><img src="${path1 }/img/img.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='png' }"><img src="${path1 }/img/img.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='hwp' }"><img src="${path1 }/img/hwp.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='doc' }"><img src="${path1 }/img/doc.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='pdf' }"><img src="${path1 }/img/pdf.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='xls' }"><img src="${path1 }/img/xls.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='ppt' }"><img src="${path1 }/img/ppt.png" alt="파일타입"/></c:if>
							<c:if test="${filetype=='pptx' }"><img src="${path1 }/img/ppt.png" alt="파일타입"/></c:if>
							<c:if test="${empty filetype}"><img src="${path1 }/img/no.png" alt="파일타입"/></c:if>
						</c:if>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<a href="${path1 }/resources/upload/${databank.dfilename }" download="">${databank.dfilename }</a>						
					</td>
				</tr>
				<tr>
