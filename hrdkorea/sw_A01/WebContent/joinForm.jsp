			...
			<form action="joinProcess.jsp" method="post" onsubmit="return check_form(this)">
				<table class="table1">
					<tbody>
						<tr>
							<th>회원번호(자동발생)</th>
							<td><input type="text" value="<%=custno %>" size="8" name="custno" readonly></td>
						</tr>
						<tr>
							<th>회원성명</th>
							<td><input type="text" size="8" name="custname"></td>
						</tr>
						<tr>
							<th>회원전화</th>
						...
						<tr>
							<th>가입일자</th>
							<td><input type="text" maxlength="8" size="8" name="joindate"></td>
						</tr>
						<tr>
							<th>고객등급[A:VIP,B:일반,C:직원]</th>
							<td><input type="text" size="8" name="grade"></td>
						</tr>
						<tr>
							<th>도시코드</th>
							<td><input type="text" size="8" name="city"></td>
						</tr>
						<tr>
							<td colspan="2">
