...
<div id="content">
	...
	%>
			...
			<tr>
				<th>시작일</th>
				<td><input type="date" name="itodate" value="<%=vo.getRtodate() %>" readonly></td>
			</tr>
			<tr>
				<th>종료일</th>
				<td><input type="date" name="ifromdate" value="<%=vo.getRfromdate() %>" readonly></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td><%=vo.getRid() %></td>
			...
			<tr>
				<td colspan="2">
					<a href="/web02/GetUserReviewListCtrl" class="frm_btn">목록</a> &nbsp; &nbsp; &nbsp; &nbsp;
				</td>
			</tr>
	<%
		}
