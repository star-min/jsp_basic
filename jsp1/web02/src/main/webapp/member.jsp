...
<form action="/web02/EditMemberCtrl" method="post">
	...
	%>
			<tr>
				<th>아이디</th>
				<td><input type="text" name="mid" value="<%=mem.getMid() %>" readonly></td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td><input type="text" name="mpw" value="<%=mem.getMpw() %>"></td>
			</tr>
			<tr>
				<th>고객명</th>
				<td><input type="text" name="mname" value="<%=mem.getMname() %>"></td>
			</tr>
			<tr>
				<th>전화번호</th>
				<td><input type="tel" name="tel" value="<%=mem.getTel() %>"></td>
			</tr>
			<tr>
				<th>이메일</th>
			...
			<tr>
				<th>생년월일</th>	
				<td><input type="date" name="birth" value="<%=mem.getBirth() %>"></td>
			</tr>
			<tr>
				<th>가입일</th>
				<td><%=mem.getJoinday() %></td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" value="수정"> &nbsp; &nbsp; &nbsp; &nbsp;
					<input type="reset" value="취소"> &nbsp; &nbsp; &nbsp; &nbsp;
					<a href="/web02/GetMemberListCtrl">목록</a>
				</td>
			</tr>
	<%
		}
