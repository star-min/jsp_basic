...
<form action="JoinProCtrl" method="post" name="joinform" id="joinform" onsubmit="return joinCheck(this)">
	...
	%>
			<tr>
				<th>아이디</th>
				<td><input type="text" name="mid" class="in_data" value="" required>
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="password" name="mpw" class="in_data" value="" required></td>
			</tr>
			<tr>
				<th>비밀번호 확인</th>
				<td><input type="password" name="mpw2" class="in_data" value="" required></td>
			</tr>
			<tr>
				<th>고객명</th>
				<td><input type="text" name="mname" class="in_data" value="" required></td>
			</tr>
			<tr>
				<th>전화번호</th>
...
<script>
function idCheck() {
	var uid = document.joinform.mid.value;
