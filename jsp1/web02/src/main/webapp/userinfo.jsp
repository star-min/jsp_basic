...
<form action="/web02/EditUserCtrl" method="post">
	...
	%>
			<tr>
				<th>아이디</th>
				<td><input type="text" name="mid" value="<%=cus.getMid() %>" readonly></td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td><input type="text" name="mpw" value="<%=cus.getMpw() %>"></td>
			</tr>
			<tr>
				<th>고객명</th>
				<td><input type="text" name="mname" value="<%=cus.getMname() %>"></td>
			</tr>
			<tr>
				<th>전화번호</th>
