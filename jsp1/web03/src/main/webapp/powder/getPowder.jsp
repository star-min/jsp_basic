			...
			<table class="table" id="lst_tb">
				<tbody>
					<tr>
						<th>카테고리</th>
						<td>
							<input type="text" name="pgory" value="" required>
						</td>
					</tr>
					<tr>
						<th>보충제명</th>
					...
					<tr>
						<th>맛</th>
						<td>
							<input type="text" name="ptaste" value="" required>
						</td>
					</tr>
					<tr>
						<th>개수</th>
						<td>
							<input type="number" name="pamount" value="" required>
						</td>
					</tr>
					<tr>
						<th>내용</th>
					...
					<tr>
						<th>제품사진</th>
						<td>
							<input type="image" name="pimage" value="" required>
						</td>
					</tr>
					<tr>
						<th>제품등록일</th>
